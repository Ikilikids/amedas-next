...
export function getRegionColor(pre) {
...
export function getFullRegionColor(pre) {
...
export function getMarkerColor(officialName) {
...
export function getIcon(officialName) {
...
export const mainKeys = ["av_avtemp", "sm_sun", "sm_rain", "sm_snowing"];
...
// 単位判定
export function detectUnitFromPath(filePath) {
  const lower = filePath.toLowerCase().replace(/\\/g, "/");
  const match = lower.match(/ranking\/([^/]+)\//);
...
export function getMonthly(data, field) {
...
export function getValuesArrayFromData(data, month, type) {
  let fields;
