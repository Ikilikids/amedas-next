...
// 型
// ==============================
export type CategoryValue = keyof typeof CategoryKey;
export type Category = (typeof CategoryKey)[CategoryValue];

// ==============================
// utils
// ==============================
export const CATEGORY_LIST = Object.keys(CategoryKey) as CategoryValue[];
